...
//variáveis
  ...
  if( !$error ) {
     ...
     $query = "UPDATE funcionario SET Nome_Fun ='$name',CPF_Fun ='$cpf',RG_Fun ='$rg',Nasc_Fun ='$nascimento',Telefone_Fun ='$telefone',Celular_Fun ='$celular',Email ='$email',CEP_Fun ='$cep',Endereco_Fun ='$endereco',Casa_Fun='$numero',Bairro_Fun ='$bairro',Cidade_Fun ='$cidade',Estado_Fun ='$estado', Admissao ='$entrada',Status_Fun ='$status'  WHERE funcionario.idFuncionario = '$id'";
   $res = mysql_query($query);
    
   if ($res) {
    echo '<script language="javascript">';
  echo 'alert("Funcionario editado com sucesso!")';
  echo '</script>';
    unset($name);
   } else {
    echo '<script language="javascript">';
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
      ...
      <div class="row">
        <div class="form-group col-md-4">
          <label for="nome">Id do Funcionario</label>
