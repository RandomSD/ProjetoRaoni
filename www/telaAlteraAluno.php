...
//variáveis
  ...
  if( !$error ) {
   ...
   $query = "UPDATE aluno SET Nome_Al ='$name',CPF_Al ='$cpf',RG_Al ='$rg',Nasc_Al ='$nascimento',Telefone_Al ='$telefone',Celular_Al ='$celular',Email_Al ='$email',CEP_Al ='$cep',Endereco_Al ='$endereco',Casa_Al='$numero',Bairro_Al ='$bairro',Cidade_Al ='$cidade',Estado_Al ='$estado',DataEntrada ='$entrada',Status_Al ='$status',Sexo_Al ='$sexo' WHERE aluno.idAluno = '$id'";
   $res = mysql_query($query);
    
   if ($res) {
    echo '<script language="javascript">';
  echo 'alert("Aluno alterado com sucesso!")';
  echo '</script>';
    unset($name);
   } else {
    echo '<script language="javascript">';
