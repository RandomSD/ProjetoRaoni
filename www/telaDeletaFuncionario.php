...
//variáveis
  ...
  if( !$error ) {
   $query = "SELECT idFuncionario FROM funcionario WHERE idFuncionario='$id'";
...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          <li><a href="gerenciamento.php">INICIO</a></li>         
  ...
  <div id="main" class="container-fluid">
    ...
    <h3 class="page-header">DELETAR FUNCIONÁRIO</h3>
    <br>
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
      ...
      <div class="row">
        <div class="form-group col-md-3">
          <label for="nome">Id do Funcionário</label>
