...
<head>
  ...
  <link href="_css/novoEstilo.css" rel="stylesheet">
</head>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li id="login"><a href="#logar">LOGAR</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div class="jumbotron text-center">
  <h1>Faça parte disso!</h1> 
  <p>Deixe seu email para ficar por dentro</p> 
  <form>
    <div class="input-group">
      <input type="email" class="form-control" size="50" placeholder="Digite seu email" required>
...
<div id="about" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
      ...
      <br><button class="btn btn-default btn-lg">Saiba mais</button>
    </div>
    <div class="col-sm-4">
  ...
  <div id="myCarousel" class="carousel slide text-center" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <h4>"Essa empresa é a melhor. Eu estou muito feliz com os resultados!"<br><span>Ronaldinho, jogador de futebol</span></h4>
      </div>
      <div class="item">
        <h4>"Uma palavra... PQP!!"<br><span>Papai Noel</span></h4>
      </div>
      <div class="item">
        <h4>"Posso ser mais feliz com essa empresa?"<br><span>Galinho Ticoliro</span></h4>
      </div>
    </div>
...
<div id="pricing" class="container-fluid">
  <div class="text-center">
    <h2>Preços</h2>
    <h4>Escolha o melhor modelo de pagamento para você</h4>
  </div>
  <div class="row slideanim">
...
<footer class="container-fluid text-center">
  ...
  <p>Site produzido por: Team Random </p>
</footer>
